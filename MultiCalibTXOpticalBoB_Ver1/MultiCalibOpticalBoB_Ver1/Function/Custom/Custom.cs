...
namespace MultiCalibOpticalBoB_Ver1.Function
{
    ...
    public class defaultsetting : INotifyPropertyChanged {
        ...
        public string ONTAPD {
            get { return Properties.Settings.Default.apdoption; }
            set {
                Properties.Settings.Default.apdoption = value;
                OnPropertyChanged(nameof(ONTAPD));
            }
        }
        #endregion
        ...
        public bool ENABLEWRITEAPD {
            get { return Properties.Settings.Default.enablewriteapdlut; }
            set {
                Properties.Settings.Default.enablewriteapdlut = value;
                GlobalData.testingDataDut1.EWRITEAPD = value;
                GlobalData.testingDataDut2.EWRITEAPD = value;
                GlobalData.testingDataDut3.EWRITEAPD = value;
                GlobalData.testingDataDut4.EWRITEAPD = value;
                OnPropertyChanged(nameof(ENABLEWRITEAPD));
            }
        }
    ...
    public class testinginfo : INotifyPropertyChanged {
        ...
        bool _ewriteadp;
        public bool EWRITEAPD {
            get { return _ewriteadp; }
            set {
                _ewriteadp = value;
                OnPropertyChanged(nameof(EWRITEAPD));
            }
        }
        ...
        string _writeapdresult;
        public string WRITEAPDRESULT {
            get { return _writeapdresult; }
            set {
                _writeapdresult = value;
                OnPropertyChanged(nameof(WRITEAPDRESULT));
            }
        }
        ...
        public void Initialization() {
            ...
            this.MACADDRESS = "--";
            this.BOSASERIAL = "--";
            this.WRITEAPDRESULT = nameof(Parameters.testStatus.NONE);
            ...
            this.EWRITEAPD = GlobalData.initSetting.ENABLEWRITEAPD;
